...
class AdvertHomepage
{
     ...
     */
    public function delete(int $advertHomepageId)
    {
...
class Category
{
    ...
    /**
     * @throws \Motv\Mw\CategoryUnknownException
     */
    public function getData(int $categoriesId): array
    {
    ...
    /**
     * @throws \Motv\Mw\CategoryDuplicateNameException
     * @throws \Motv\Mw\CategoryUnknownException
     */
    public function update(int $categoriesId, array $data): int
    {
...
class Channel
{
    ...
    public function changeChannelsStatus(array $ids, bool $status)
    {
     ...
     * @throws \Motv\Mw\GenreDuplicateNameException
     * @throws \Motv\Mw\GenreUnknownException
     ...
     * @throws \Motv\Mw\TemplateUnknownException
     */
    public function delete(int $channelsId)
    {
     ...
     * @throws \Motv\Mw\ChannelUnknownException
     */
    public function deleteBroadcast(int $channelsBroadcastId)
    {
     ...
     * @throws \Motv\Mw\ChannelUnknownException
     */
    public function deleteMulticast(int $channelsMulticastId)
    {
     ...
     * @throws \Motv\Mw\TemplateUnknownException
     */
    public function deleteUnicast(int $channelsUnicastId)
    {
     ...
     * @throws \Motv\Mw\ChannelUnknownException
     */
    public function getBroadcast(int $channelsBroadcastId): array
    {
     ...
     * @throws \Motv\Mw\TemplateUnknownException
     */
    public function getUnicast(int $channelsUnicastId, string $language = 'en'): array
    {
     ...
     * @throws \Motv\Mw\ChannelUnknownException
     */
    public function updateBroadcast(int $channelsId, int $channelsBroadcastId, array $data): int
    {
     ...
     * @throws \Motv\Mw\SystemFailedToUploadFileException
     */
    public function uploadUnicastInputFile(int $storagesId, string $directory, string $filename, string $content)
    {
...
class Customer
{
     ...
     */
    public function addMacAddress(int $customersId, string $macAddress)
    {
     ...
     */
    public function assignQRCode(int $code, int $customersId)
    {
        $this->connector->call("Customer", "assignQRCode", get_defined_vars());
    }


    public function delete(int $customersId)
    {
     ...
     * @throws \Motv\Mw\CustomerUnknownException
     */
    public function getDataByLogin(string $login, int $vendorsId): array
    {
    ...
    public function removeAllMacAddresses(int $customersId)
    {
        $this->connector->call("Customer", "removeAllMacAddresses", get_defined_vars());
    }


    public function removeMacAddress(int $customersMacAddressId)
    {
...
class Device
{
     ...
     * @throws \Motv\Mw\DeviceUnknownException
     */
    public function removeDevice(int $devicesId)
    {
...
class Edge
{
    ...
    public function getEdgesByChannelUnicast(int $channelsUnicastId, string $contentType): array
    {
        return $this->connector->call("Edge", "getEdgesByChannelUnicast", get_defined_vars());
    }


    public function getEdgesByPackages(array $packages): array
    {
        return $this->connector->call("Edge", "getEdgesByPackages", get_defined_vars());
    }
...
class Epg
{
     ...
     * @throws \Motv\Mw\PersonUnknownPersonException
     */
    public function processEpg(int $channelsId, string $content)
    {
     ...
     * @throws \Motv\Mw\EpgUnknownEpgEventException
     */
    public function setRecordedEventTime(int $epgEventsId, int $second)
    {
...
class EpgPlaylist
{
     ...
     * @throws \Motv\Mw\EpgUnknownEpgEventException
     */
    public function addEventsToPlaylist(int $epgPlaylistsId, array $epgEventsIds)
    {
     ...
     * @throws \Motv\Mw\EpgUnknownEpgEventException
     */
    public function updateEventPlaylists(int $epgEventsId, array $epgPlaylistsIds)
    {
...
class Genre
{
     ...
     * @throws \Motv\Mw\GenreUnknownException
     */
    public function getData(int $genresId): array
    {
     ...
     * @throws \Motv\Mw\GenreUnknownException
     */
    public function update(int $genresId, array $data): int
    {
...
class Monitoring
{
    ...
    public function clearLogs(int $channelsUnicastId)
    {
...
class Ota
{
     ...
     * @throws \Motv\Mw\OtaUnknownVersionException
     */
    public function latestById(int $id): array
    {
...
class Person
{
    ...
    public function getPairs(string $type = null): array
    {
...
class Profile
{
     ...
     * @throws \Motv\Mw\ProfileUnknownException
     */
    public function delete(int $profilesId)
    {
     ...
     * @throws \Motv\Mw\ProfileUnknownException
     */
    public function resetChannelOrder(int $profilesId, string $type = null)
    {
     ...
     * @throws \Motv\Mw\ProfileUnknownException
     */
    public function updateChannelOrder(int $profilesId, string $type, array $channels)
    {
     ...
     * @throws \Motv\Mw\ProfileUnknownException
     */
    public function updateChannelWhitelisting(int $profilesId, array $channels)
    {
...
class Recording
{
     ...
     */
    public function addRecording(int $profilesId, string $devicesType, int $epgEventsId): array
    {
     ...
     */
    public function getData(int $epgEventsId, int $profilesId, string $devicesType): array
    {
     ...
     * @throws \Motv\Mw\ProfileUnknownException
     */
    public function getRecordingsByProfile(int $profilesId, string $devicesType = null, string $language = 'en', bool $v2 = false): array
    {
     ...
     * @throws \Motv\Mw\RecordingUnknownException
     */
    public function removeRecording(int $profilesId, int $epgEventsId, bool $expired = false)
    {
...
class Statistic
{
    ...
    public function updateRoleHomepageStatistics(int $rolesId, array $data)
    {
...
class Subscription
{
     ...
     * @throws \Motv\Mw\ProfileUnknownException
     */
    public function cancelPackage(int $customersId, int $packagesId)
    {
    ...
    /**
     * @throws \Motv\Mw\ConfigUnknownValueException
     * @throws \Motv\Mw\HomepageInvalidCategorySelectionSearchCriteriaException
     ...
     * @throws \Motv\Mw\PackageUnknownException
     */
    public function subscribePackage(int $customersId, int $packagesId)
    {
...
class Template
{
     ...
     * @throws \Motv\Mw\TemplateUsedException
     */
    public function deleteTemplate(int $templatesId)
    {
     ...
     * @throws \Motv\Mw\TemplateUnknownException
     */
    public function getData(int $templatesId, string $language = 'en'): array
    {
...
class Transcoder
{
     ...
     */
    public function deleteStreamRecording(int $streamRecordingsId)
    {
     ...
     * @throws \Motv\Mw\TranscoderUnableToContactException
     */
    public function gracefulRestartTranscoder(string $transcoder)
    {
    ...
    public function restartChannel(int $channelsUnicastId)
    {
     ...
     * @throws \Motv\Mw\TranscoderUnableToContactException
     */
    public function restartChannelUnicastTranscoder(string $transcoder, int $channelsUnicastId)
    {
...
class Vod
{
     ...
     * @throws \Motv\Mw\VodUnknownException
     */
    public function delete(int $vodsId)
    {
     ...
     * @throws \Motv\Mw\VodUnknownException
     */
    public function guessVodVideoAudioSubtitle(int $vodsId)
    {
     ...
     * @throws \Motv\Mw\VodUnknownException
     */
    public function transcode(int $vodsId)
    {
