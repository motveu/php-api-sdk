...
class AdminConnector extends \Motv\Connector
{
	...
	public function VodCategory(): VodCategory
	{
		return new VodCategory($this);
	}


	public function VodGenre(): VodGenre
	{
		return new VodGenre($this);
	}
}
