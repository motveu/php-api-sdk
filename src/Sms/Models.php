...
class Custom_Cico
{
	...
	public function cancelSubscription(int $viewers_id): void
	{
		$this->connector->call("Custom_Cico", "cancelSubscription", get_defined_vars());
	}


	public function confirmOrder(int $orders_id): void
	{
...
class Devices_Motv
{
	...
	public function apiChangePassword(string $password, ?string $token = null, ?string $login = null, ?string $code = null): void
	{
	...
	public function finishSocialRegistration(int $device_motv_id): void
	{
...
class Epg
{
	...
	public function groupGenerateXmltvFiles(array $ids, string $day): void
	{
...
class User
{
	...
	public function updateNotificationsViewStatus(array $ids): void
	{
		$this->connector->call("User", "updateNotificationsViewStatus", get_defined_vars());
	}


	public function updateNotificationViewStatus(int $users_notifications_id): void
	{
